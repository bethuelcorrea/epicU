<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CS_ASP_022_Code.Default" %>
...
<body>
   <form id="form1" runat="server">
    <div>
        ...
        <br />
        <br />
        <asp:Button ID="okButton" runat="server" OnClick="okButton_Click" Text="OK" style="width: 33px" />
        <br />
        <br />
